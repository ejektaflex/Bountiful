...
object KambrikRegistrar {
    ...
    data class RegistrationEntry<T>(val registry: SimpleRegistry<T>, val itemId: String, val item: T) {
    ...
    fun <T> register(requester: KambricAutoRegistrar, reg: SimpleRegistry<T>, itemId: String, obj: T): T {
